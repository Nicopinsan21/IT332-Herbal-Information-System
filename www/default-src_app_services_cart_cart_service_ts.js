(self["webpackChunkgrp3_fnlproj"] = self["webpackChunkgrp3_fnlproj"] || []).push([["default-src_app_services_cart_cart_service_ts"],{
...
;(function (global, factory) {
    true ? factory(__webpack_require__(/*! ../moment */ 8361)) :
   0
...
/* harmony import */ var _utility_utility_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utility/utility.service */ 3703);
...
let CartService = class CartService {
    ...
    addLocalCartItems() {
        this.unseen += 1;
        console.log('add to fav>:', this.items, this.item);
...
CartService.ctorParameters = () => [
    { type: _utility_utility_service__WEBPACK_IMPORTED_MODULE_0__.UtilityService }
];
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ 8361);
...
let UtilityService = class UtilityService {
    ...
    dismissLoading() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            this.isLoading = false;
            if (this.loadingCtrl) {
                return yield this.loadingCtrl.dismiss().then(resp => {
    ...
    /* Show Toast*/
    showToast(msg, position, type = "success") {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
    ...
    confirm(config) {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const alert = yield this.alertCtrl.create({
                mode: "ios",
                cssClass: 'my-custom-class',
                header: (_a = config.header) !== null && _a !== void 0 ? _a : 'Confirm!',
                message: (_b = config.message) !== null && _b !== void 0 ? _b : 'Are you sure?',
                buttons: [
                    {
                        text: 'No',
                        role: 'cancel',
    ...
    getFormatTime(date) {
        return moment__WEBPACK_IMPORTED_MODULE_0__(date).format('LT');
    }
    randomStr(length) {
        var result = '';
